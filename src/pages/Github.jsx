...
export default function Github() {
    ...
    useEffect(() => {
        const fetchInfosProfile = async () => {
            try {
                ...
                setInfosProfile(response.data); // Utilisation de response.data
            } catch (error) {
    ...
    if (!infosProfile) return <div>Loading...</div>;
    ...
    return (
        <section className="d-flex justify-content-center align-items-center flex-column">
            ...
            <img className="mb-5" src={infosProfile.avatar_url} alt={infosProfile.longin}/>
